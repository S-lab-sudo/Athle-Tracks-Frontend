...
const Basketball =
  "https://res.cloudinary.com/dwe0jsgt6/image/upload/v1746081601/basketball_pjr5pq.webp";
const box = {
...
const Home = () => {
  const Court =
    "https://res.cloudinary.com/dwe0jsgt6/image/upload/v1746081604/Court_fa3s9k.avif";
  ...
  return (
    <div className="">
      ...
      <div className="absolute z-30 top-20 flex flex-col gap-10 justify-between items-center w-full px-1 md:px-16 pt-12">
        <div className="flex justify-center items-center w-full h-full">
          {/* Tournament Details Card */}
          <div className="md:w-[55%] w-[70%]">
            <div className="bg-black bg-opacity-80 rounded-lg shadow-lg md:p-5 p-3 border border-orange-500/30">
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  <div className="bg-orange-500/20 p-3 rounded-lg flex justify-between">
                    ...
                    <h2 className="text-xl font-bold text-white">
                      NPR{" "}
                      {tournamentData.prizePool.firstPrize === "TBD"
                        ? "TBD"
                ...
                {/* Register Button */}
                {tournamentData.registerable==="true"?(
